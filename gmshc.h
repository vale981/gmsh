...
GMSH_API void gmshModelMeshSetSizeCallback(double (*sizeCallback)(int dim, int tag, double x, double y, double z, double lc, void * data), void * sizeCallback_data,
                                           int * ierr);
...
GMSH_API void gmshModelMeshSetMetricCallback(void (*metricCallback)(int dim, int tag, double x, double y, double z, double lc, double * metric, void * data), void * metricCallback_data,
                                             int * ierr);
