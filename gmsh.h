...
namespace gmsh { // Top-level functions
  ...
  namespace model { // Model functions
    ...
    namespace mesh { // Mesh functions
      ...
      GMSH_API void setSizeCallback(std::function<double(int, int, double, double, double, double)> sizeCallback);
      ...
      // gmsh::model::mesh::setMetricCallback
      //
      // Set a mesh size callback for the current model. The callback function
      // should take seven arguments as input (`dim', `tag', `x', `y', `z', `lc'
      // and `metric'). The first two integer arguments correspond to the dimension
      ...
      GMSH_API void setMetricCallback(std::function<void(int, int, double, double, double, double, double *)> metricCallback);

      // gmsh::model::mesh::removeMetricCallback
      //
      // Remove the mesh metric callback from the current model.
      GMSH_API void removeMetricCallback();
